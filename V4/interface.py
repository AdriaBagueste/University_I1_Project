...
class AirspaceApp:
    ...
    def setup_ui(self):
        ...
        frame.grid_columnconfigure(12, weight=1)  # Make the last column expandable
    ...
    def _create_new_simple_graph(self):
        ...
        self.airspace = None
        self.update_v2_dropdowns() # Update dropdowns (they will likely be empty)
